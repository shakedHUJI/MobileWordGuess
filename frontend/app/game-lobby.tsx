    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <BackButton 
          shouldConfirm={true} 
          goToIndex={false} 
          confirmMessage="Are you sure you want to leave the lobby?"
        />
        <MotiView
        ...
        >
          ...
          <View style={styles.gameContainer}>
            ...
            <View style={styles.playersListContainer}>
              <Text style={styles.heading}>Challengers ({players.length}/10):</Text>
              <FlatList
                data={players}
                renderItem={({ item }) => (
            ...
            <View style={styles.buttonContainer}>
              <CustomButton
                style={[
                  styles.button,
                  (!isHost || players.length < 2 || players.length > 10) && styles.buttonDisabled,
                ]}
                onPress={startGame}
                disabled={!isHost || players.length < 2 || players.length > 10}
              >
